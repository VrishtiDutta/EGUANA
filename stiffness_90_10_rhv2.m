function [velocity, ampl, velo1,dur, stiffness, cvalue, xtime, percent,...
 ...
 allind10_90,velocity10_90,peakinsample,peak,peaknumber]=...
 stiffness_90_10_rhv2(signal,rate,peaknumber,valleynumber,peakinsample,...
 valleyinsample, peak, valley, loweramp, higheramp)
 ...
 % (stiffness_90_10_rh.m) 
 
 % Date: 22/07/10, by Rafael H 
 %-------------------------------------------------------------------------
...
for i=1:c
  ...
  %1st movement (velley to peak)-----  
    ...
    ampl(i)=(higheramp-loweramp)*totalampl*0.01;% 10 -90 amplitude
    
    pervalue10=valley(i)+(0.01*loweramp)*totalampl;
    pervalue90=peak(i)-(0.01*(100-higheramp))*totalampl;
  ...
  %2nd movement (peak to valley)------
    ...
    ampl2(i)=(higheramp-loweramp)*totalampl*0.01;% 90 -10 amplitude
    
    pervalue10=valley(i+1)+(0.01*loweramp)*totalampl;
    pervalue90=peak(i)-(0.01*(100-higheramp))*totalampl;
