...
function [dur3, sumdur3, val00,val01,val02,val03,val04,val05,val06,val07,val08,val09,val010,val011,val012,val013,...
    ...
    val024,val025,val000,val2000] = stiffness_figure_rh (pos, signal, peaktime, peak, valleytime, valley, velocity,...
    ampl,velo1, dur, stiffness, cvalue, percent,ampl2, velo2 ,dur2, stiff2,...
    cvalue2,percent2, val000, val2000, lastsubject, trialnum, namevariable)

handle = figure('Position', pos,'name',['Kinematic values ',namevariable]);
