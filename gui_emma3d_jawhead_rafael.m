function varargout = gui_emma3d_jawhead_rafael(varargin)
% GUI_EMMA3D_JAWHEAD_RAFAEL M-file for gui_emma3d_jawhead_rafael.fig
%      GUI_EMMA3D_JAWHEAD_RAFAEL, by itself, creates a new GUI_EMMA3D_JAWHEAD_RAFAEL or raises the existing
%      singleton*.
%
%      H = GUI_EMMA3D_JAWHEAD_RAFAEL returns the handle to a new GUI_EMMA3D_JAWHEAD_RAFAEL or the handle to
%      the existing singleton*.
%
%      GUI_EMMA3D_JAWHEAD_RAFAEL('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_EMMA3D_JAWHEAD_RAFAEL.M with the given input arguments.
%
%      GUI_EMMA3D_JAWHEAD_RAFAEL('Property','Value',...) creates a new GUI_EMMA3D_JAWHEAD_RAFAEL or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before gui_emma_3d_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to gui_emma3d_jawhead_rafael_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help gui_emma3d_jawhead_rafael

% Last Modified by GUIDE v2.5 07-Aug-2011 15:48:51

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @gui_emma3d_jawhead_rafael_OpeningFcn, ...
                   'gui_OutputFcn',  @gui_emma3d_jawhead_rafael_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before gui_emma3d_jawhead_rafael is made visible.
function gui_emma3d_jawhead_rafael_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to gui_emma3d_jawhead_rafael (see VARARGIN)
...
% Choose default command line output for gui_emma3d_jawhead_rafael
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes gui_emma3d_jawhead_rafael wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = gui_emma3d_jawhead_rafael_OutputFcn(hObject, eventdata, handles) 
...
[x3dc,y3dc,z3dc,phic,thetac]=KCcorrection(path,trial,numbercoil,handles.x3d_lp,...
...
handles.thetahead = phic;
handles.phihead   = thetac;
handles.currentdatax = handles.x3dhead;
handles.currentdatay = handles.y3dhead;
handles.currentdataz = handles.z3dhead;
handles.currentdatap = handles.phihead;
...
if (length(numbercoil)==3)
    ...
    method=questdlg('what vertion do you want to use?',...
        'JOANA', 'Simple Jaw C','Angular Jaw C','Simple Jaw C');
    switch method
        case 'Simple Jaw C'      
            % August 06/08/11 Rafael Henriques
       ...
       %'because current head correction method do not correct angles'};
        ...
        %        questdlg(msg,'warning','OK','OK');
         ...
         %   else
                ...
                set(handles.currentjawmethod,'string',...
                    ['Current Method ' char(39) 'JOANA' char(39)]);
                
                [x3dc,y3dc,z3dc,phic,thetac]=JOANA(numbercoil,handles.x3dhead,...
                    handles.y3dhead,handles.z3dhead,handles.phihead,handles.thetahead,0);
          %  end
...
if (length(numbercoil)==3)
    ...
    switch method
        case 'Simple Jaw C'
            [x3dc,y3dc,z3dc,phic,thetac]=KCcorrection(path,Rest_trial,numbercoil, ...
                handles.x3dhead,...
...
% OLD button to make the analysis for the Rafael Henriques & Pascal van Lieshout
% Paper
...
% --- Executes on button press in HJCInfo.
function HJCInfo_Callback(hObject, eventdata, handles)
% hObject    handle to HJCInfo (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
GUI_INFO_CORRECTIONS


% --- Executes on button press in HIST_demo.
function HIST_demo_Callback(hObject, eventdata, handles)
% hObject    handle to HIST_demo (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
path=handles.path1;
trialbite=get(handles.bite_trial,'String');
...
PaperHistogramEGUANAdemo(handles.x3d_lp,handles.y3d_lp,handles.z3d_lp,...
    handles.phi_lp,handles.theta_lp,...
    path,trialbite,numbercoil,numbercoilhead,handles.sub,handles.tri)
