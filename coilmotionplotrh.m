function coilmotionplotrh(x,y,z,rate,ac,rateac)
...
uipanel('Title','Coils Motion','FontSize',14,...
...
hsa=subplot('position',[0.1 0.77 0.8 0.15]);
hold(hsa,'on')
...
%mouth coils
hmouth=plot3(hs1,[x(1,10) x(1,6) x(1,9) x(1,7) x(1,10)],...
               [y(1,10) y(1,6) y(1,9) y(1,7) y(1,10)],...
               [z(1,10) z(1,6) z(1,9) z(1,7) z(1,10)]);
set(hmouth,'tag','mouth','color',[1 0.4 0],'Marker','.',...
    'Markersize',10,'LineWidth',2)

%jaw coil
hjaw=plot3(hs1,x(1,8),y(1,8),z(1,8));
set(hjaw,'tag','jaw','Marker','.','Markersize',12)
...
set(hmouth,'xdata',[x(i,10) x(i,6) x(i,9) x(i,7) x(i,10)],...
    'ydata',[y(i,10) y(i,6) y(i,9) y(i,7) y(i,10)],...
    'zdata',[z(i,10) z(i,6) z(i,9) z(i,7) z(i,10)])
set(hjaw,'xdata',x(i,8),'ydata',y(i,8),'zdata',z(i,8))
drawnow,%pause(0.01)
end
