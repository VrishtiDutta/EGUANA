function DaveDFAEstimation(sig,xname)

%% definitions

hfig=figure('name',['Dave DFA analiyze' xname]);
...
%             'ForegroundColor',gor,'visible','on');
        ...
        [logxrw,logyrw]=DaveDFA_rh(diff(rw));
        xroi=logxrw;
        yroi=logyrw;
        p=polyfit(xroi,yroi,1);
        hurstrw=p(1);
