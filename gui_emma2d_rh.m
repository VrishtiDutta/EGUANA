function varargout = gui_emma2d_rh(varargin)
% GUI_EMMA2D_RH M-file for gui_emma2d_rh.fig
%      GUI_EMMA2D_RH, by itself, creates a new GUI_EMMA2D_RH or raises the existing
%      singleton*.
%
%      H = GUI_EMMA2D_RH returns the handle to a new GUI_EMMA2D_RH or the handle to
%      the existing singleton*.
%
%      GUI_EMMA2D_RH('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_EMMA2D_RH.M with the given input arguments.
%
%      GUI_EMMA2D_RH('Property','Value',...) creates a new GUI_EMMA2D_RH or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before gui_emma_2dv2_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to gui_emma2d_rh_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help gui_emma2d_rh

% Last Modified by GUIDE v2.5 14-Sep-2010 21:49:52

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @gui_emma2d_rh_OpeningFcn, ...
                   'gui_OutputFcn',  @gui_emma2d_rh_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%% --- Executes just before gui_emma2d_rh is made visible.
function gui_emma2d_rh_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to gui_emma2d_rh (see VARARGIN)
...
handles.Fs = 16000;
handles.player = audioplayer(data2d.ac2d,16000);
...
% Choose default command line output for gui_emma2d_rh
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes gui_emma2d_rh wait for user response (see UIRESUME)
% uiwait(handles.figure1);


%% --- Outputs from this function are returned to the command line.
function varargout = gui_emma2d_rh_OutputFcn(hObject, eventdata, handles) 
...
% gui_emma2d_rh so you can choose which 2 signals to analyze
...
if ch == 0
    ...
    if strcmp(dim,'x'), sig_string = [chtag, dim]; 
    elseif strcmp(dim,'y'),  sig_string = [chtag,dim];
    end
end
