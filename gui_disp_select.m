...
% Last Modified by PVL v2.6 23-FEB-2011 11:27:24
...
handles.ac = data3d.ac;
handles.sig1ch = data3d.sig1ch;
handles.sig2ch = data3d.sig2ch;
handles.sig3ch = data3d.sig3ch;
handles.sig4ch = data3d.sig4ch;

set(handles.ch1,'String',handles.sig1ch);
set(handles.ch2,'String',handles.sig2ch);
set(handles.ch3,'String',handles.sig3ch);
set(handles.ch4,'String',handles.sig4ch);

discrete_phase_instructions;
scnsize=get(0, 'ScreenSize');
set(gcf, 'Units' , 'Pixel');
set(gcf, 'Position', [0, 0.8*scnsize(4), 0.25*scnsize(3), 0.12*scnsize(4)]);
...
warndlg('Select as 1st signal the articulator that is the first target in onset of word sequence, e.g., tongue dorsum for kop top');
...
if goahead == 0
    ...
    sig2 = handles.z3d(:,s(1));
    sig3 = handles.x3d(:,s(2));
    sig4 = handles.z3d(:,s(2));
    sig5 = handles.x3d(:,s(3));
    sig6 = handles.z3d(:,s(3));
    sig7 = handles.z3d(:,s(4));
    sig8 = handles.ac;
    name1 = get_name(s(1));
    name2 = name1;
    name3 = get_name(s(2));
    ...
    % signal 7 is y of reference
    % signal 8 is acoustics
    discrete_phase_prog_pvl1(sig1,sig2,sig3,sig4,sig5,sig6,sig7,sig8,name1,name2,name3,name4,name5,name6,name7);
end
